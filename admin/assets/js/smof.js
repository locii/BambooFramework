...
jQuery(document).ready(function($){
	...
	// Custom Bamboo toggles	
	// Hide options
	jQuery('#section-logoimage').hide();
	jQuery('#section-logo_googlefont').hide();
	jQuery('#section-body_googlefont').hide();
	jQuery('#section-nav_googlefont').hide();
	jQuery('#section-heading_googlefont').hide();
	
	
	// Check if Google is default
	if (jQuery('#logofont_face').val() == "-1") {
	   jQuery('#section-logo_googlefont').show();
	} 
	else {
		jQuery('#section-logo_googlefont').hide();
	}
	...
	if (jQuery('#bodyfont_face').val() == "-1") {
	   jQuery('#section-body_googlefont').show();
	} 
	else {
		jQuery('#section-body_googlefont').hide();
	}
	...
	if (jQuery('#navfont_face').val() == "-1") {
	   jQuery('#section-nav_googlefont').show();
	} 
	else {
		jQuery('#section-nav_googlefont').hide();
	}
	...
	if (jQuery('#headingfont_face').val() == "-1") {
	   jQuery('#section-heading_googlefont').show();
	} 
	else {
		jQuery('#section-heading_googlefont').hide();
	}
	...
	jQuery('#logotype').change(function() {
	    if (jQuery('#logotype').val() == "Text") {
	       jQuery('#section-logotext').show();
	       jQuery('#section-logofont').show();
	       jQuery('#section-logoimage').hide();
	    } 
	    else {
		    if (jQuery('#logotype').val() == "Image") {
		       jQuery('#section-logoimage').show();
		       jQuery('#section-logofont').hide();
		       jQuery('#section-logotext').hide();
		    }
		}
	});
	...
	// Logo Font
	jQuery('#logofont_face').change(function() {
		if (jQuery('#logofont_face').val() == "-1") {
		   jQuery('#section-logo_googlefont').show();
		} 
		else {
	...
	// Body Font
	jQuery('#bodyfont_face').change(function() {
		if (jQuery('#bodyfont_face').val() == "-1") {
		   jQuery('#section-body_googlefont').show();
		} 
		else {
	...
	// Nav Font
	jQuery('#navfont_face').change(function() {
		if (jQuery('#navfont_face').val() == "-1") {
		   jQuery('#section-nav_googlefont').show();
		} 
		else {
	...
	// Heading Font
	jQuery('#headingfont_face').change(function() {
		if (jQuery('#headingfont_face').val() == "-1") {
		   jQuery('#section-heading_googlefont').show();
		} 
		else {
